...
const Autofill = () => {
    ...
    const platforms = [
        ...
        { name: 'iPhone', icon: 'https://www.lastpass.com/-/media/dfe72332941949108b0d9e467da20da7.svg?la=en&hash=EDE2A66001ABEB06B025A6FCE73B85FF', description: 'Our iOS app now supports in-app autofill for one-touch login.' },
        ...
        { name: 'Mozilla Firefox', icon: 'https://www.lastpass.com/-/media/0bca9bcaa7d1442f86f94a16e7525ecd.svg?la=en&hash=B9B9A4B8A9A0A787B5774AB5141FC812', description: 'Autofill forms and log in just one-click with our Firefox extension.' },
        ...
        { name: 'Microsoft Edge', icon: 'https://www.lastpass.com/-/media/3779614c8f824752a176d758bd83a711.svg?la=en&hash=F53FF0347FD9EF7AA21A6A3D0D3E2834', description: 'Save and autofill passwords with our Microsoft Edge extension.' },
        { name: 'Opera Browser', icon: 'https://www.lastpass.com/-/media/a19e66a8dd2942ea8397c43ca26c7d3f.svg?la=en&hash=745A508049A55116A27776356C9B2FA7', description: 'Save and autofill passwords with our Microsoft Edge extension.' },
        ...
        <>
            <header className="relative h-[85vh] flex items-center justify-center text-center text-white font-bold rounded-lg" style={{ marginTop: '' }}>
                ...
                <div className="relative z-20 w-full px-4 py-8">
                    <h1 className="text-5xl md:text-7xl mb-6">Autofill</h1>
                    <p className="text-xl md:text-3xl mb-4">Intelligent, Safe, Efficient</p>
                    <p className="text-lg md:text-xl text-blue-200 mb-6">Autofill simplifies and speeds up form completion, enhancing user convenience and reducing errors</p>
            ...
            {/* benefits of Autofill (cards) */}
            <section className="py-20 bg-gray-50 font">
                <div className="container mx-auto text-center">
                    <h2 className="text-4xl font-semibold mb-4">Simplify your online life with save and autofill</h2>
